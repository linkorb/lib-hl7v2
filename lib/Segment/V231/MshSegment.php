...
class MshSegment extends AbstractHeaderSegment
{
     ...
     */
    private $dateTimeOfMessage = null;
    /**
     * @var \Hl7v2\DataType\V231\StDataType
     */
    ...
    /**
     * @var \Hl7v2\DataType\V231\PtDataType
     */
    private $processingId;
    /**
     * @var \Hl7v2\DataType\V231\VidDataType
     */
    private $versionId;
    /**
     ...
     * @param string $value
     */
    public function setFieldMessageType(string $value)
    {
        $this->messageType = $this
            ->dataTypeFactory
            ->create('CM', $this->encodingParameters)
        ;
        $this->messageType->setValue($value);
    }
    ...
    /**
     * @return \Hl7v2\DataType\V231\PtDataType
     */
    ...
    /**
     * @return \Hl7v2\DataType\V231\VidDataType
     */
    ...
    public function fromDatagram(Datagram $datagram, Codec $codec)
    {
        ...
        $this->checkFieldLength('SendingApplication', 180, $datagram->getPositionalState());
        $sequence = [1,1,1];
        list(
            $namespaceId,
            $universalId,
        ...
        $this->checkFieldLength('SendingFacility', 180, $datagram->getPositionalState());
        $sequence = [1,1,1];
        list(
            $namespaceId,
            $universalId,
        ...
        $this->checkFieldLength('ReceivingApplication', 180, $datagram->getPositionalState());
        $sequence = [1,1,1];
        list(
            $namespaceId,
            $universalId,
        ...
        $this->checkFieldLength('ReceivingFacility', 180, $datagram->getPositionalState());
        $sequence = [1,1,1];
        list(
            $namespaceId,
            $universalId,
        ...
        $this->checkFieldLength('MessageType', 7, $datagram->getPositionalState());
        $this->setFieldMessageType($codec->extractComponent($datagram));
        ...
        $this->checkFieldLength('PrincipalLanguageOfMessage', 60, $datagram->getPositionalState());
    ...
    public function __toString()
    {
        ...
        if (!$this->getFieldMessageType() || !$this->getFieldMessageType()->hasValue()) {
            ++$emptyFieldsSinceLastField;
        } else {
            $s .= str_repeat(
                $this->encodingParameters->getFieldSep(),
                1 + $emptyFieldsSinceLastField
            ) . (string) $this->getFieldMessageType()->getValue();
            $emptyFieldsSinceLastField = 0;
        }
