...
class AcknowledgementGeneratorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testAckGenWillPopulateAckMessageHeader()
    {
        $data = $this
            ->datagramBuilder
            ->withMessage('MSH|^~\&|ACME|ACMETESTCENTRUM|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1|||AL|AL||8859/1')
            ->build()
        ;
        $senderConfig = [
    ...
    public function dataAckCodeProduction()
    {
        return [
            'Orig rule, reject' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1||||||8859/1',
                false, true, 'AR'
            ],
            'Orig rule, fail' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1||||||8859/1',
            ...
            'Enhanced rule, ack always, reject' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1|||AL|||8859/1',
                false, true, 'CR'
            ],
            ...
            'Enhanced rule, ack never, reject' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1|||NE|||8859/1',
                false, true, null
            ],
            ...
            'Enhanced rule, ack on success, reject' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1|||SU|||8859/1',
                false, true, null
            ],
            ...
            'Enhanced rule, ack on error, reject' => [
                'MSH|^~\&|ACME|ACME|TEST|TEST|20160719132745||ORU^R01|906|P|2.5.1|||ER|||8859/1',
                false, true, 'CR'
            ],
